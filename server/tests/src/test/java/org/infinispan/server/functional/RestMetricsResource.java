...
public class RestMetricsResource {
   ...
   private static void checkIsPrometheus(MediaType contentType) {
   ...
   private static void checkIsOpenmetrics(MediaType contentType) {
   ...
   private static void checkRule(String body, String key, Consumer<String> check) throws Exception {
